...
const Portfolio = () => {
    ...
    return (
        <div ref={sectionRef} className="bg-[#F5F2EE] text-black">
            ...
            {/* 🔥 FEATURED STORY */}
            <section className="bg-linear-to-br from-[#2D1F15] to-[#1E1510] py-16">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">

                        {/* Left Text */}
                        <div>
                            <p className="font-['Outfit'] font-light text-[10px] tracking-[0.4em] text-(--gold) mb-4">
                                FEATURED SHOOT
                            </p>

                            <h2 className="font-['Cormorant_Garamond'] font-light text-[72px] leading-tight mb-2">
                                <span className="text-white">Rahul & Priya</span>
                            </h2>

                            <h3 className="font-['Cormorant_Garamond'] font-light italic text-[48px] text-(--gold) mb-6">
                                Wedding Story
                            </h3>

                            <p className="font-['Outfit'] font-light text-[13px] text-white/60 mb-8">
